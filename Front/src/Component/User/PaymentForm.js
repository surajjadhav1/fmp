            ...
            {orderPlaced ? <PaymentDoneLoading /> : <div className="text-center" style={{ marginTop: "5%" }}>
                ...
                <div className="container">
                    ...
                    <Cards
                        ...
                        focused={focus}
                    /> 
                    <p className="mt-5">Use Following details for payment <br/>Card Number: 4444-4444-4444-3333 <br/>Exp Date: 12/25 <br/>CVC: 654</p>
                </div>
                        </div>
                        <div className="col-xl-5 border border-primary p-4">
                            <form class="row g-3" onSubmit={(event) => sendData(event)}>

                                <div class="col-12">
                                    <h5 className="text-success fw-bold mb-3">Card details</h5>
                                ...
                                <div className="text-center">
                                    <button type="submit" class="btn btn-dark form-control">Pay INR {props.amount}</button>
                                </div>
